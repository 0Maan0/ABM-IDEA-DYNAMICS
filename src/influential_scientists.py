...
class ScientistAgent(Agent):
    ...
    def update_belief(self, success, theory_choice, weight=1.0):
        ...
        # Weight=1.0: full evidence, Weight=0.0: no evidence (prior unchanged)
        weighted_p_result_if_new = (1-weight) * 0.5 + weight * p_result_if_new
        weighted_p_result_if_old = (1-weight) * 0.5 + weight * p_result_if_old
